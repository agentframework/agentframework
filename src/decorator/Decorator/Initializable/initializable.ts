...
import { AddAttributeToConstructor } from '@agentframework/core.ts';
import { InitializerAttribute } from './InitializerAttribute.ts';
import { StaticInitializerAttribute } from './StaticInitializerAttribute.ts';
