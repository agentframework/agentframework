...
// import { MemberAnnotation } from './Annotation';
...
//   const annotations = Object.create(prototype && Wisdom.type(prototype.constructor));
...
import { ParameterAnnotation, PropertyAnnotation } from './Annotation';

export function GetParameterAnnotation(
  annotation: PropertyAnnotation,
  target: Function,
  property: PropertyKey,
  index: number
