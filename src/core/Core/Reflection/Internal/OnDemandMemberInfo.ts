...
import { Annotation, DefineIfValue } from '../../Meta';
import { MemberInfo } from '../MemberInfo.ts';
import { Filter } from '../Filter.ts';
import { HasInterceptor } from '../../Interception/CustomInterceptor.ts';
import { Cache } from './Cache.ts';
import { Class } from '../../Interception/Class.ts';
...
export abstract class OnDemandMemberInfo<A extends Annotation = Annotation> implements MemberInfo {
   ...
   */
  get name(): string {
    return DefineIfValue(this, 'name', this.getName());
  }
  ...
  get declaringType(): Function {
    return DefineIfValue(this, 'declaringType', this.getDeclaringType());
  }
   ...
   */
  get kind(): number {
    return DefineIfValue(this, 'kind', this.getKind());
  }
  ...
  get type(): Function | undefined {
    return DefineIfValue(this, 'type', this.getType());
  }
  ...
  hasOwnInterceptor(): boolean {
    return this.ownInterceptors !== undefined;
  }
   ...
   */
  abstract addAttribute<A4 extends object>(attribute: A4): void;
}
