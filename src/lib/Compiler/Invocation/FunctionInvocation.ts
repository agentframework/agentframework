...
export class MethodInvocation implements IInvocation {
  target: any;
  constructor(readonly method: Function, readonly design: any) {}
...
export class ParameterizedMethodInvocation implements IInvocation {
  target: any;
  constructor(readonly method: Function, readonly design: any, readonly params: Map<number, IInvocation>) {}
