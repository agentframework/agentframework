...
// import { AddAttributeToClassGetter } from '../Annotation/AddAttribute';
//
// export class OnDemandPropertyGetterInfo extends OnDemandMemberInfo {
//   get kind(): MemberKinds {
//     return MemberKinds.Getter;
//   }
//
