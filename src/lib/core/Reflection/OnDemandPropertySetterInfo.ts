...
//
// export class OnDemandPropertySetterInfo extends OnDemandMemberInfo {
//   get kind(): MemberKinds {
//     return MemberKinds.Setter;
//   }
//
