...
describe('1.6. Agent with decorators', () => {
  describe('# should able to', () => {
    it('get decorators from Agent', () => {
      ...
      expect(r1.getAttributes().length).toBe(1);
      expect(r1.getOwnProperties().length).toBe(1);
      const p2 = r1.getProperty('name');
      expect(p2).toBeDefined();
      if (p2) {
        expect(p2.getAttributes().length).toBe(1);
    ...
    it('get decorators from Extended Agent', () => {
      ...
      if (nameField) {
        expect(nameField.getAttributes().length).toBe(1);
      ...
      if (addressField) {
        expect(addressField.getAttributes().length).toBe(1);
